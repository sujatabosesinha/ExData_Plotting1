##
## Exploratry Data Analysis Assignment Week 1 Plot 2
## This plot creates a line graph with the days of week on ##horizontal axis and Global active power on vertical axis. ##The pattern shows increase in power use during the day and ##greatly reduced power use at night for 1 ##family with a 1 ##minute sampling rate from February 1, 2007 ##to February 2, ##2007.
##
